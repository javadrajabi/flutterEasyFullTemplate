...
//
//
//   static Future<int> Now() async {
//     DateTime.now().toUtc().millisecondsSinceEpoch;
//   }
//   static Future<String> UtcToUnixTime() async {
//
//   }
//    Future UnixTimeToJalali(unixTime) async {
//
//      JDate.fromDateTime(DateTime.now());
//      JDate.fromMicrosecondsSinceEpoch(int microsecondsSinceEpoch, {bool isUtc = false});
//    return DateTime(2020).toJDate();
//   }
//
// // From DateTime
//   print('\n---From DateTime---');
