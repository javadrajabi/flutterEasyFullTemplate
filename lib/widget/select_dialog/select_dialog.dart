          ...
          if (widget.showSearchBox)
            Padding(
              ...
              child: TextField(
                ...
                decoration: widget.searchBoxDecoration?.copyWith(hintText: widget.searchHint ?? widget.searchBoxDecoration!.hintText) ?? InputDecoration(hintText: widget.searchHint ?? "جستجو", contentPadding: const EdgeInsets.all(2.0)),
              ),
            ),
          Expanded(
            child: StreamBuilder<List<T>?>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  ...
                  return widget.emptyBuilder?.call(context) ?? Center(child: Text("چیزی پیدا نشد"));
                }
                return Scrollbar(
